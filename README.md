...
## 🏗 Architecture
- **Data Source:** Yahoo Finance API (`yfinance`) — Gold Futures (`GC=F`) with ETF fallbacks (`GLD`, `IAU`)
...
- **Resilience:** Multi-ticker fallback, retry logic, duplicate protection, corrupted JSON recovery
